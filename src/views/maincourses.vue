...
const submitForm = async () => {
    ...
    try {
        ...
        if (editProduct.value) {
            res = await fetch(`https://67a720d9510789ef0dfd0df6.mockapi.io/mainCourses${editProduct.value.id}`, {
                method: "PUT",
            ...
            res = await fetch("https://67a720d9510789ef0dfd0df6.mockapi.io/mainCourses", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(payload),
            });
...
onMounted(async () => {
    try {
        const res = await fetch("https://67a720d9510789ef0dfd0df6.mockapi.io/mainCourses");
