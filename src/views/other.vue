...
const pop = ref(false);
const editProduct = ref(null); // محصولی که الان داریم ویرایش می‌کنیم
...
const onEditClick = (product) => {
    // پر کردن فرم با داده‌های محصول انتخاب شده
    ...
    img.value = null; // عکس جدید اختیاری
    editProduct.value = product; // ذخیره محصول برای آپدیت
    pop.value = true; // باز کردن پنل
};
